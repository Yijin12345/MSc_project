...
% via_var1=0.001*eye(4);
% via_var2=100*eye(4);
via_var1=10*eye(4);
via_var2=1E-6*eye(4);
via_var3=10*eye(4);
via_var4=10*eye(4);
[newRef,newLen] = kmp_insertPoint(newRef,newLen,via_time(1),via_point(:,1),via_var1);
[newRef,newLen] = kmp_insertPoint(newRef,newLen,via_time(2),via_point(:,2),via_var2);
[newRef,newLen] = kmp_insertPoint(newRef,newLen,via_time(3),via_point(:,3),via_var3);
[newRef,newLen] = kmp_insertPoint(newRef,newLen,via_time(4),via_point(:,4),via_var4);
